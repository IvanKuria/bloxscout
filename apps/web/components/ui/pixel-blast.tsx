...
// reactbits.dev PixelBlast (three.js + postprocessing WebGL background),
// installed via `npx shadcn add https://reactbits.dev/r/PixelBlast-TS-TW`.
// Mounted only through the ssr:false dynamic wrapper in `hero-backdrop.tsx`,
// which also gates it behind prefers-reduced-motion.
