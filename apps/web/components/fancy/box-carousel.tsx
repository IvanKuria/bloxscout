/**
 * Vendored from fancycomponents.dev (danielpetho/fancy) — "Box Carousel".
 * A draggable 3D cube carousel. Only depends on `motion/react` (installed) and
 * `cn`. Respects `prefers-reduced-motion` via `useReducedMotion`. SSR-safe under
 * `"use client"` (window listeners are attached inside effects).
 */
"use client";
